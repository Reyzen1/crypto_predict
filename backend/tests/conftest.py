...
# Clean imports without backend prefix (pytest runs from backend/)
...
def client(test_db_session):
    """Create test client with database override and proper headers (FIXED FOR 400 ERRORS)"""
    def override_get_db():
        try:
    ...
    # FIX: Add proper headers to prevent "Invalid host header" 400 errors
    with TestClient(app, base_url="http://testserver") as test_client:
        # Set proper headers to fix 400 Bad Request errors
