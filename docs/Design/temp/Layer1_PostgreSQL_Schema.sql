-- ===============================================
-- docs\Design\Layer1_PostgreSQL_Schema.sql
...
CREATE INDEX idx_price_data_candle_time_desc ON price_data(candle_time DESC);
CREATE INDEX idx_price_data_asset_candle_time ON price_data(asset_id, candle_time DESC);
