# File: ./scripts/fix-crypto-repository.sh
# Fix cryptocurrency repository SQLAlchemy query issue

#!/bin/bash

set -e

echo "🔧 Fixing Cryptocurrency Repository Query Issue"
echo "==============================================="
...
echo "📝 Updating cryptocurrency repository..."

# Create fixed cryptocurrency repository
...
echo "✅ Cryptocurrency repository fixed!"

echo ""
echo "🔧 Key changes made:"
echo "   - Fixed get_by_symbol: func.upper(Cryptocurrency.symbol) == symbol.upper()"
echo "   - Fixed search_cryptos: Using ilike() instead of upper()" 
echo "   - All SQLAlchemy query syntax corrected"

echo ""
echo "🧪 Now run the test again:"
echo "   ./scripts/test-repositories.sh"